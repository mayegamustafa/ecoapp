...
import 'local/chat_selected_file.dart';

class SellerChatView extends HookConsumerWidget {
  const SellerChatView(this.id, {super.key});
  ...
  Widget build(context, WidgetRef ref) {
    ...
    final chatDetails = ref.watch(sellerChatDetailsProvider(id));
    final chatCtrl =
        useCallback(() => ref.read(sellerChatDetailsProvider(id).notifier));
    final files = useState<List<io.File>>([]);
    final msgCtrl = useTextEditingController(text: url);

    final selected = useState<List<SellerMassage>>([]);

    final refreshCtrl = RefreshController();

    void addToSelected(SellerMassage msg) {
              ...
              Expanded(
                ...
                child: SmartRefresher(
                  ...
                  child: CustomScrollView(
                    ...
                    physics: const AlwaysScrollableScrollPhysics(),
                    slivers: [
                      SliverGroupedListView<SellerMassage, DateTime>(
